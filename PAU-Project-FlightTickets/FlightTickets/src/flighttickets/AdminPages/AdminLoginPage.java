...
import flighttickets.AdminPages.AdminPanel;
import flighttickets.DataBaseProcesses.DataBaseConnecter;
import flighttickets.CustomerPages.LoginPage;
...
public class AdminLoginPage extends javax.swing.JFrame {
	...
	public AdminLoginPage(LoginPage loginPage) {
		initComponents();
	...
	public boolean login(String username, String password) {
		...
		try {
			...
			ResultSet resultSet = preparedStatement.executeQuery(); // checks whether the user is on the admin table
			if( resultSet.next()) {
	 ...
	 */
	 @SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                setBounds(new java.awt.Rectangle(499, 299, 0, 0));
                setResizable(false);

                jPanel1.setBackground(new java.awt.Color(43, 46, 55));

                jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/flighttickets/adminLogo.png"))); // NOI18N

                jPanel2.setBackground(new java.awt.Color(0, 0, 0));
                jPanel2.setPreferredSize(new java.awt.Dimension(398, 207));
                ...
                usernameArea.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
                ...
                jPanel2Layout.setHorizontalGroup(
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(passwordArea, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE))
                                .addGap(31, 31, 31))
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                jPanel1Layout.setVerticalGroup(
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(customerLoginButton, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap())
                );
		...
		this.loginPage.setVisible(true); // closes the current object and opens an loginPage of customer
		this.dispose();
		...
		if(login(username, password)) {
			...
			this.setVisible(false); // closes the current object and open an adminPanel
